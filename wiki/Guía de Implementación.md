...
| -------------       | -------------       | -----------------     | ------------         |
| **Solution Type** | Elija el tipo de implementación de la solución en el menú desplegable, para obtener más información sobre el tipo de implementación de la solución, vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | Basic, Standard, Premium | Basic|
| **Edge VM + Simulator VM** | Elija Yes/No para agregar Modbus VM como parte de la implementación de la Solución, para obtener más información sobre Modbus VM, vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | Yes, No    | No |
| **mlVM**   | Elija Yes/No para agregar ML VM como parte de la implementación de la solución, para obtener más información sobre ML VM, vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | Yes, No   | No |
| **Data Lake Location** | Elija la ubicación de Data Lake Store; para obtener más información sobre Data Lake Store, vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | Eastus2,Centralus, Northeurope, westeurope  | Eastus2 |
| **Machine learning Location** | Elija la ubicación para la cuenta machine learning, para obtener más información sobre machine learning vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | Eastus2, Australieneast, Southeastasia, Westcentralus, Westeurope | eastus2 |
| **Geo Paired Primary Region** | Elija la región geo-emparejada, si ha seleccionado la opción estándar o premium en el parámetro de entrada del tipo de solución, para obtener más información sobre la región geo-emparejada, vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | EastUS2,CentralUS,WestUS2,WestCentralUS,CanadaCentral,CanadaEast,         AustraliaEast,AustraliaSouthEast,CentralIndia,SouthIndia,EastAsia,               SouthEastAsia,JapanWest,JapanEast,KoreaCentral,KoreaSouth,UKSouth,               UKWest  | eastus2|
| **oms-region** | Elija la ubicación para OMS Log Analytics; para obtener más información sobre oms, vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | australiasoutheast, canadacentral, centralindia, eastus, japaneast, southeastasia, uksouth, westeurope    | EastUs |
| **appInsightsLocation**   | Especifique la región para application insights, para obtener más información sobre application insights vaya a https://github.com/DJuanes/iot-edge-dynocard/blob/master/dynocards-wiki/Deployment-Guide.md | eastus, northeurope,  southcentralus, southeastasia, westeurope, westus2 | westus2 |
